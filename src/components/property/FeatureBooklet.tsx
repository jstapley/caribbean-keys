...
export function FeatureBooklet({ propertyId }: FeatureBookletProps) {
  ...
  return (
    <section className="py-12 bg-caribbean-seafoam/10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 text-caribbean-gold font-semibold text-sm uppercase tracking-wide mb-2">
            <Sparkles className="h-4 w-4" />
            Feature Highlights
          </div>
          <h2 className="text-3xl font-bold text-caribbean-navy">
        ...
        <div className="relative">
          ...
          <div
            key={spread.id}
            className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 animate-in fade-in duration-300"
          >
          ...
          {spreads.length > 1 && (
            <>
              <button
                ...
                className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 lg:-translate-x-14 bg-white shadow-lg rounded-full p-3 hover:bg-caribbean-gold hover:text-white transition text-caribbean-navy"
              >
              ...
              <button
                ...
                className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 lg:translate-x-14 bg-white shadow-lg rounded-full p-3 hover:bg-caribbean-gold hover:text-white transition text-caribbean-navy"
              >
