...
const GOOGLE_REVIEW_URL = "https://g.page/r/Ca7u9-BL3IHjEBM/review"
  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          {!loading && !error && totalReviews > 0 && (
            <div className="flex items-center justify-center gap-2 mt-3">
              <span className="text-2xl font-bold text-caribbean-navy">{rating.toFixed(1)}</span>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      {review.profilePhoto ? (
                        ...
                        <div className="w-8 h-8 rounded-full bg-caribbean-navy flex items-center justify-center text-white text-sm font-bold">
                          {review.author?.charAt(0)}
                        </div>
                      )}
                      <div>
                        <p className="font-semibold text-caribbean-navy text-sm">{review.author}</p>
        ...
        {/* Error or No Reviews Fallback */}
        {!loading && (error || reviews.length === 0) && (
          <div className="text-center text-gray-500 mb-12">
            <p>Reviews temporarily unavailable. Check back soon!</p>
          </div>
        )}
