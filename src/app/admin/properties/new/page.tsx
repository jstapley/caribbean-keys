...
export default function AddPropertyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Step 3: Inserting into Supabase...', propertyData)
      ...
      console.log('Step 4: Property created successfully:', data)
      ...
      const errorMessage = error?.message || error?.error_description || JSON.stringify(error) || 'Failed to create property'
